      ...
      allUsers: [
        {
          stream: {
            ...
            _links: {
              ...
              editors:
                "https://api.twitch.tv/kraken/channels/freecodecamp/editors",
              teams: "https://api.twitch.tv/kraken/channels/freecodecamp/teams",
              videos:
                "https://api.twitch.tv/kraken/channels/freecodecamp/videos"
            }
          },
          _links: {
        ...
        },
        {
          stream: {
            ...
            _links: {
              ...
              commercial:
                "https://api.twitch.tv/kraken/channels/esl_sc2/commercial",
              stream_key:
                "https://api.twitch.tv/kraken/channels/esl_sc2/stream_key",
